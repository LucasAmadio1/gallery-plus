...
import FileImgIcon from "../assets/icons/image.svg?react";
...
export default function InputSingleFile({
  ...
  const { fileSize, fileExtension } = useMemo(
    () => ({
    ...
    <div>
      {!formFile || !isValidFile() ? (
        ...
        <>
          ...
          <div className="flex gap-3 items-center border border-solid border-border-primary mt-5 p-3 rounded-sm">
            <Icon svg={FileImgIcon} className="fill-white w-6 h-6" />
